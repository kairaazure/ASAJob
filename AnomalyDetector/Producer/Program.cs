...
namespace Producer
{
    ...
    {        
        private const string EventHubConnectionString = "Endpoint=sb://kbnamespace2019.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=/lu4PNnDuChlV9xWiBYr8fxJE3bk3C4B/1Xrc4bSwV0=";
        private const string EventHubName = "kbeventhub2019 ";
